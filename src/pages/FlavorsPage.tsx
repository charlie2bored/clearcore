...
export default function FlavorsPage() {
  return (
    <>
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 px-6 bg-milk">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <motion.h1
            ...
            className="mt-3 font-display uppercase text-dark-brown text-[14vw] md:text-[7.5vw] leading-[0.95]"
          >
            Three flavors.
            <br />
          ...
          <motion.p
            ...
            className="mt-6 text-dark-brown/80 max-w-xl mx-auto"
          >
      ...
      {/* grid */}
      <section className="py-16 md:py-20 px-6 bg-milk">
      ...
      <section className="bg-dark-brown text-milk text-center py-20 md:py-28 px-6">
        ...
        <p className="mt-4 text-milk/80 max-w-md mx-auto">
